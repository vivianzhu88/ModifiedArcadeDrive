...
void ModifiedArcadeDrive::Drive(double xSpeed, double zRotation){
...
bool ModifiedArcadeDrive::PIDTurnThread(float degreesClockwise, float radius, float maxVel, float timeout, bool ZeroVelocityAtEnd){
...

   {
      ...
      thread = new std::thread(&ModifiedArcadeDrive::PIDTurn, this, degreesClockwise, radius, maxVel, timeout, ZeroVelocityAtEnd);
...
void ModifiedArcadeDrive::initPID(){
...
void ModifiedArcadeDrive::enableP(){
...
void ModifiedArcadeDrive::disableP(){
...
void ModifiedArcadeDrive::setAccel(float accl){
...
void ModifiedArcadeDrive::stopAutoThread()
...
void ModifiedArcadeDrive::joinAutoThread()
